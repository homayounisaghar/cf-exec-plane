...
PREV_CONTROL=8401980fa765a9810a5d4fa6f636502e379e643d
TARGET_CONTROL=3bef6ae0a09e517fb4030187091bf226c1d68b88
...
assert x["controlRevision"]==551
assert a["productionEpoch"]==22 and a["mode"]=="QUIESCED_RECONCILING" and a["materialAuthority"] is None
...
print("CF_R8_Q_AUTHORITY=epoch22-quiesced")
print("CF_R8_Q_RELEASE=seq73-r8")
print("CF_R8_Q_GUARD=engaged-empty-zero")
print("CF_R8_Q=pass")
PY
