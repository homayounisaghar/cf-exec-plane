...
print("CF_E9_SLICE_GUARD=semantic-lab-only-budget4")
PY
...
rm -f "$GATE"
[[ ! -e "$GATE" ]]
echo CF_E9_SLICE_LOCAL_WINDOW=open
...
console.log("CF_E9_PRE_TOP_Z="+initialZ);
...
console.log("CF_E9_MID_TOP_Z="+midZ);
...
console.log("CF_E9_POST_TOP_Z="+finalZ);
console.log("CF_E9_GEOMETRY_FORWARD_DELTA="+String(midZ-initialZ));
console.log("CF_E9_GEOMETRY_RESTORED="+String(Math.abs(finalZ-initialZ)<1e-9));
console.log("CF_E9_SLICE_A=pass");
...
echo CF_E9_SLICE_RELEASE_GATE=active
echo CF_E9_SLICE_GATEWAY=stopped
echo CF_E9_SLICE=pass
