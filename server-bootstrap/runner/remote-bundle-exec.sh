...
[[ -n "${CF_ONSHAPE_BROWSER_OPEN_DOCUMENT_ID:-}" ]] && remote_env+=("CF_ONSHAPE_BROWSER_OPEN_DOCUMENT_ID=$CF_ONSHAPE_BROWSER_OPEN_DOCUMENT_ID")
[[ -n "${CF_ONSHAPE_BROWSER_OPEN_WORKSPACE_ID:-}" ]] && remote_env+=("CF_ONSHAPE_BROWSER_OPEN_WORKSPACE_ID=$CF_ONSHAPE_BROWSER_OPEN_WORKSPACE_ID")
[[ -n "${CF_ONSHAPE_BROWSER_OPEN_ELEMENT_ID:-}" ]] && remote_env+=("CF_ONSHAPE_BROWSER_OPEN_ELEMENT_ID=$CF_ONSHAPE_BROWSER_OPEN_ELEMENT_ID")
[[ -n "${CF_ONSHAPE_BROWSER_ACTION:-}" ]] && remote_env+=("CF_ONSHAPE_BROWSER_ACTION=$CF_ONSHAPE_BROWSER_ACTION")
[[ -n "${CF_ONSHAPE_POINTER_ACTION:-}" ]] && remote_env+=("CF_ONSHAPE_POINTER_ACTION=$CF_ONSHAPE_POINTER_ACTION")
[[ -n "${CF_ONSHAPE_POINTER_X_FRACTION:-}" ]] && remote_env+=("CF_ONSHAPE_POINTER_X_FRACTION=$CF_ONSHAPE_POINTER_X_FRACTION")
[[ -n "${CF_ONSHAPE_POINTER_Y_FRACTION:-}" ]] && remote_env+=("CF_ONSHAPE_POINTER_Y_FRACTION=$CF_ONSHAPE_POINTER_Y_FRACTION")
[[ -n "${CF_ONSHAPE_POINTER_WHEEL_STEPS:-}" ]] && remote_env+=("CF_ONSHAPE_POINTER_WHEEL_STEPS=$CF_ONSHAPE_POINTER_WHEEL_STEPS")
[[ -n "${CF_ONSHAPE_POINTER_WHEEL_DELTA_Y:-}" ]] && remote_env+=("CF_ONSHAPE_POINTER_WHEEL_DELTA_Y=$CF_ONSHAPE_POINTER_WHEEL_DELTA_Y")
[[ -n "${CF_ONSHAPE_POINTER_DELTA_X:-}" ]] && remote_env+=("CF_ONSHAPE_POINTER_DELTA_X=$CF_ONSHAPE_POINTER_DELTA_X")
[[ -n "${CF_ONSHAPE_POINTER_DELTA_Y:-}" ]] && remote_env+=("CF_ONSHAPE_POINTER_DELTA_Y=$CF_ONSHAPE_POINTER_DELTA_Y")
