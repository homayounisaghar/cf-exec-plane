...
attempt="attempt:fa78a198-d5ae-47e8-af44-a441f89236dc"
operation="operation:502932a9-3623-4040-a9f4-fb2a37126f4a"
...
print("CF_PHASE0_CORPUSRECON_PRODUCTION_FAILCLOSED=pass")
print("CF_PHASE0_CORPUSRECON_CONTROL_REV="+str(d["controlRevision"]))
print("CF_PHASE0_CORPUSRECON_EPOCH="+str(a["productionEpoch"]))
PY
...
echo CF_PHASE0_CORPUSRECON_BINDING=pass
...
print("CF_PHASE0_CORPUSRECON_PREFLIGHT=pass")
print("CF_PHASE0_CORPUSRECON_ATTEMPT="+attempt)
print("CF_PHASE0_CORPUSRECON_OPERATION="+operation)
print("CF_PHASE0_CORPUSRECON_DETAIL="+str(obs.get("detail")))
con.close()
PY
...
print("CF_PHASE0_CORPUSRECON_AGENT="+json.dumps(safe,separators=(",",":"),sort_keys=True))
PY
...
try:
    ...
    print("CF_PHASE0_CORPUSRECON_HTTP="+str(status))
    print("CF_PHASE0_CORPUSRECON_ERROR="+raw[:2000])
    raise
assert status==200
...
print("CF_PHASE0_CORPUSRECON_RECONCILE="+json.dumps(safe,separators=(",",":"),sort_keys=True))
PY
...
assert claim < effect
print("CF_PHASE0_CORPUSRECON_PRE_EFFECT_ORDER=pass")
print("CF_PHASE0_CORPUSRECON_PERSIST_BEFORE_EFFECT=pass")
PY
...
new_obs["detail"]="reconciled corpus snapshot probe as proven pre-effect SESSION_UNKNOWN before runtime.viewer"
...
print("CF_PHASE0_CORPUSRECON_OUTCOME=ABSENT")
print("CF_PHASE0_CORPUSRECON_EFFECT_SENT=false")
print("CF_PHASE0_CORPUSRECON_REEXECUTED=false")
PY
...
print("CF_PHASE0_CORPUSRECON_READBACK=pass")
PY

echo CF_PHASE0_CORPUSRECON=pass
